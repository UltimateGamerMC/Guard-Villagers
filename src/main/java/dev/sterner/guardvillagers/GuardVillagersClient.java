...
public class GuardVillagersClient implements ClientModInitializer {
    ...
    public static EntityModelLayer GUARD = new EntityModelLayer(Identifier.of(GuardVillagers.MODID, "guard"), "main");
    public static EntityModelLayer GUARD_STEVE = new EntityModelLayer(Identifier.of(GuardVillagers.MODID, "guard_steve"), "main");
    public static EntityModelLayer GUARD_ARMOR_OUTER = new EntityModelLayer(Identifier.of(GuardVillagers.MODID, "guard_armor_outer"), "main");
    public static EntityModelLayer GUARD_ARMOR_INNER = new EntityModelLayer(Identifier.of(GuardVillagers.MODID, "guard_armor_inner"), "main");
